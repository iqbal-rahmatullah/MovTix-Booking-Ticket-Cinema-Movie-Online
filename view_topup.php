...
$id_topup = $_GET['id'];
$view_topup = hasil_query("SELECT * FROM topup WHERE id = '$id_topup'")[0];

if ($view_topup['id_user'] != $id_res) {
...
<head>
    ...
    <title>MovTix | Top Up #<?php echo $view_topup['id'] ?></title>
    <!-- plugins:css -->
                        ...
                        <div class=" col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="alert alert-danger m-3" role="alert">
                                    <i class="mdi mdi-information"></i> Make sure you make the correct transfer according to the nominal listed
                                </div>
                                <div class="card-body d-flex justify-content-center align-items-center flex-column text-center">
                                    <img src="assets/img/atm.png" alt="" class="mb-4" width="180px">
                                    <h3>Rp. <?php echo $view_topup['total'] ?></h3>
                                    <p>Please make a transfer to the following account, after that wait for the admin to confirm your top up</p>
                                    <div class="border border-primary mb-3 px-4 py-2">
                                        <i class="mdi mdi-bank mdi-36px"></i>
                                        <h5>Atomic Bank</h5>
                                        <h5>121212321321321</h5>
                                        <h5>MovTix</h5>
                                    </div>
