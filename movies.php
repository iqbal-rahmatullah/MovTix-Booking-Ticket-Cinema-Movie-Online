                ...
                <div class="content-wrapper">
                    <div class="row ">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">All Movie</h3>
                                    <div class="row mt-3 mx-auto">
                                        <?php foreach ($data_movie as $movie) { ?>
                                            <div class="col-md-3">
                                                <div class="movie-card mb-2">
                                                    <div class="movie-header" style="background-image: url('<?php echo $movie['poster_url'] ?>');">
                                                        <div class="header-icon-container">
                                                            <a href="detail_movies.php?id=<?php echo $movie['id'] ?>">
                                                    ...
                                                    <div class="movie-content">
                                                        <div class="movie-content-header">
                                                            <a href="detail_movies.php?id=<?php echo $movie['id'] ?>">
                                                                <h3 class="movie-title"><?php echo $movie['judul'] ?></h3>
                                                            </a>
                                                        </div>
                                                        <div class="movie-info">
                                                            <div class="info-section">
                                                                <label>Date Release</label>
                                                                <span><?php echo $movie['tanggal_rilis'] ?></span>
                                                            </div>
                                                            <div class="info-section">
                                                                <label>Price</label>
                                                                <span><?php echo $movie['harga_tiket'] ?></span>
                                                            </div>
                                                            <div class="info-section">
                                                                <label>For Age</label>
                                                                <span><?php echo $movie['ketentuan_umur'] - 1 ?>++</span>
                                                            </div>
                                                            <div class="info-section">
                                                                <label>Seat</label>
                                                                <span>64</span>
                                                        ...
                                                        <div class="d-flex justify-content-center mt-3">
                                                            <a class="btn btn-warning" href="detail_movies.php?id=<?php echo $movie['id'] ?>"><i class="mdi mdi-ticket-confirmation"></i> Book Now</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
