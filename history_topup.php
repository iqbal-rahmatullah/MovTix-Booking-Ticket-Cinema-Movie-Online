...
$data_topup = hasil_query("SELECT * FROM topup WHERE id_user = '$id_res'");
$data_withdraw = hasil_query("SELECT * FROM withdraw WHERE id_user = '$id_res'");
...
<head>
    ...
    <title>MovTix | History Balance</title>
    <!-- plugins:css -->
                                    ...
                                    <div class="table-responsive">
                                        <?php if ($status_topup) { ?>
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php foreach ($data_topup as $orders) { ?>
                                                        <tr class="text-center">
                                                            <td>#TOPUP-<?php echo $orders["id"] ?> </td>
                                                            <td> <?php echo $orders["total"] ?> </td>
                                                            <td>
                                                                BANK <span class="ml-3 <?php if ($orders['status'] != 'pending') echo 'd-none' ?>""> <a href=" view_topup.php?id=<?php echo $orders['id'] ?>" class=" btn btn-info"><i class="mdi mdi-script"></i> Pay now</a></span>
                                                            </td>
                                                            <td><label class="badge badge-success <?php if ($orders['status'] == 'pending') echo 'badge-warning' ?>"><?php echo $orders['status'] ?></label></td>
                                                        </tr>
                                                    <?php } ?>
                                                    <?php foreach ($data_withdraw as $orders) { ?>
                                                        <tr class="text-center">
                                                            <td>#WITHDRAW-<?php echo $orders["id"] ?> </td>
                                                            <td> <?php echo $orders["total"] ?> </td>
                                                            <td>
                                                                BANK
                                                            </td>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <td colspan="4" class="text-center text-white">
                                                        <h3>You have no balance transaction</h3>
                                                    </td>
                                                </tbody>
                                            </table>
                                        <?php } ?>
