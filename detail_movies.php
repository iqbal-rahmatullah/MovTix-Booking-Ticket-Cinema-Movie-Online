                ...
                <div class="content-wrapper">
                    <div class="row ">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title text-center"><i class="mdi mdi-information"></i> <?php echo $data_movie['judul'] ?></h3>
                                    <div class="movie_card mt-md-4" id="ave">
                                        <div class="info_section">
                                            <div class="movie_header d-md-flex align-items-center">
                                                <img class="locandina rounded" src="<?php echo $data_movie['poster_url'] ?>" width="250" />
                                                <div class="d-md-flex flex-column mx-4">
                                                    <h1><?php echo $data_movie['judul'] ?></h1>
                                                    <h4 class="text-warning d-sm-block">Rp. <?php echo $data_movie['harga_tiket'] ?> / Seat</h4>
                                                    <span class="minutes"><i class="mdi mdi-timer"></i> <?php echo $data_movie['durasi'] ?> min</span>
                                                    <span class="minutes"><i class="mdi mdi-calendar-text"></i> <?php echo $data_movie['tanggal_rilis'] ?></span>
                                                    <strong><i class="mdi mdi-human-child"></i> For <?php echo $data_movie['ketentuan_umur'] - 1 ?>++</strong>
                                                    <span class="minutes"><i class="mdi mdi-chair-school"></i> 64 Seat</span>
                                                </div>
                                            </div>
                                            <div class="movie_desc">
                                                <p class="text">
                                                    <?php echo $data_movie['deskripsi'] ?>
                                                </p>
                                            </div>
                                            <div class="movie_social d-flex justify-content-center">
                                                <button class="btn btn-warning px-5 py-3 mb-4" data-bs-toggle="modal" data-bs-target="#modalBook"><i class="mdi mdi-ticket-confirmation"></i> Book Now</button>
                                            </div>
                                        </div>
                                        <div class="blur_back ave_back" style="background-image: url('<?php echo $data_movie['banner_url'] ?>');"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal fade" id="modalBook" tabindex="-1" aria-labelledby="modalBook" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="mdi mdi-cart-plus text-warning"></i> Order Form</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="alert alert-warning" role="alert">
                                                Maximum order 6 ticket / transaction
                                            </div>
                                            <form action="orders.php" method="POST">
                                                <div class="mb-3">
                                                    <label for="total_tiket" class="col-form-label">Total Ticket:</label>
                                                    <input type="number" name="total_tiket" class="form-control" id="total_tiket" min="1" max="6" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="tanggal_pemesanan" class="col-form-label">Date :</label>
                                                    <input type="date" min="<?= date('Y-m-d'); ?>" name="tanggal_pemesanan" class="form-control" id="tanggal_pemesanan" required>
                                                </div>
