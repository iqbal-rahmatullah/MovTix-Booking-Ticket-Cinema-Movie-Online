...
$all_order = hasil_query("SELECT * FROM orders WHERE id_user = $id_res AND status = 'Paid' ORDER BY tanggal_order DESC LIMIT 4");
$topup_trx = hasil_query("SELECT * FROM topup WHERE id_user = $id_res AND status = 'success' ORDER BY id DESC LIMIT 2");
$withdraw_trx = hasil_query("SELECT * FROM withdraw WHERE id_user = $id_res ORDER BY id DESC LIMIT 2");
                ...
                <div class="content-wrapper">
                    <div class="row ">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title text-center"><i class="mdi mdi-bank"></i> Withdraw Balance</h3>
                                    <div class="alert alert-warning" role="alert">
                                        Make sure your balance is more than the balance you want to withdraw!
                                    </div>
                                    <form class="forms-sample" method="POST" action="proses_withdraw.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group-prepend">
                                                <span class="input-group-text bg-info"><i class="mdi mdi-bank text-white"></i></span>
                                                <input type="number" class="form-control" id="bank_number" placeholder="Bank Number" name="rekening">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="atas_nama">On behalf of</label>
                                            <div class="input-group-prepend">
                                                <span class="input-group-text bg-info"><i class="mdi mdi-account-circle text-white"></i></span>
                                                <input type="text" class="form-control" id="atas_nama" placeholder="Your Bank Name" name="atas_nama">
                                            </div>
                                        </div>

                                        <div class="d-flex justify-content-center">
                                            <button type="submit" class="btn btn-primary mr-2 px-4 py-3">Withdraw</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
