...
<head>
  ...
  <title>MovTix | Admin Dashboard</title>
  <!-- plugins:css -->
          ...
          <div class="row ">
            <div class="col-12 grid-margin">
              <div class="alert alert-warning">
                <strong>Attention!</strong> You are on the admin page
              </div>
              <div class="alert alert-info">
                <strong>Info!</strong> You can make system changes on this page
              </div>
              <div class="card">
                <div class="card-body d-flex justify-content-center flex-column">
                  <div class="d-flex justify-content-center">
                    <img src="../assets/img/boy.png" class="rounded-circle" alt="Cinque Terre" width="150">
                  </div>
                  ...
                  <div class="d-md-flex justify-content-center text-center">
                    <a href="manage_user.php" class="btn btn-primary mx-2 my-1">Manage user</a>
                    <a href="manage_order.php" class="btn btn-primary mx-2 my-1">Manage order transaction</a>
                    <a href="manage_topup.php" class="btn btn-primary mx-2 my-1">Manage top up transaction</a>
                    <a href="manage_withdraw.php" class="btn btn-primary mx-2 my-1">Manage withdraw transaction</a>
                  </div>
                </div>
              </div>
            </div>
