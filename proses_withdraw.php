...
$saldo_now = $data_user['saldo'];

$profile_img = $data_user['jenis_kelamin'] = "Laki-Laki" ? "boy.png" : "girl.png";

$status = $total <= $data_user['saldo'] ? true : false;

if ($status) {
    $query = "INSERT INTO withdraw VALUES(NULL, '$id_res', '$total', '$rekening', '$atas_nama', 'pending')";
    mysqli_query($koneksi, $query);
    $query2 = "UPDATE data_user SET saldo = $saldo_now - $total WHERE id = $id_res";
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row ">
                        <div class=" col-12 grid-margin stretch-card <?php if ($status) echo "d-none" ?>">
                            <div class="card">
                                <div class="card-body d-flex justify-content-center align-items-center flex-column text-center">
                                    ...
                                    <p>The balance you withdraw is greater than the balance you have</p>
                        ...
                        <div class=" col-12 grid-margin stretch-card <?php if (!$status) echo "d-none" ?>">
                            <div class="card">
                                <div class="alert alert-warning m-3" role="alert">
                                    <i class="mdi mdi-information"></i> The withdraw process takes a maximum of 1 x 24 hours
                                </div>
                                <div class="card-body d-flex justify-content-center align-items-center flex-column text-center">
                                    <img src="assets/img/checked.png" alt="" class="mb-4" width="180px">
                                    <h3>Rp. <?php echo $total ?></h3>
                                    <p>The process of disbursing your funds will be processed by the admin, monitor the progress on the history menu</p>
                                    <div class="border border-primary mb-3 px-4 py-2">
                                        <i class="mdi mdi-bank mdi-36px"></i>
                                        <h5>BANK</h5>
                                        <h5><?php echo $rekening ?></h5>
                                        <h5><?php echo $atas_nama ?></h5>
                                    </div>
                                    <a href="index.php" class="btn btn-warning">Back to dashboard</a>
                                </div>
                            </div>
